    ...
    <div className="min-w-full">
      <div style={{ width: "1440px", margin: "0 auto", minHeight: "100vh" }}>
        ...
        <Routes>
          ...
          <Route path="/wardrobe" element={<WardrobePage onNavigate={handleNavigate} />} />
          <Route path="/recommend" element={<RecommendationPage onNavigate={handleNavigate} />} />
          <Route path="/profile" element={<ProfilePage onNavigate={handleNavigate} />} />
          <Route path="/tryon" element={<VirtualTryOnPage onNavigate={handleNavigate} />} />
        </Routes>
      </div>
    </div>
  );
