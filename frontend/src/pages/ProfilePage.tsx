...
import {
  ...
  Ruler, Weight, Calendar, Award, TrendingUp, Heart
} from "lucide-react";
            ...
            <div className="bg-card rounded-2xl p-6 shadow-card mb-4 text-center">
              ...
              <div className="text-left mb-4">
                <div className="flex items-center justify-between mb-2">
                  <span className="text-xs text-muted-foreground">资料完善度</span>
                      ...
                      >
                        <div className="flex items-center gap-4">
                          ...
                          <div>
                            ...
                            <div className="text-xs text-muted-foreground">{outfit.date}</div>
                          </div>
                        </div>
                        <div className="flex items-center gap-2">
                          <span className="text-sm font-bold text-forest">{outfit.score}%</span>
                      ...
                      >
                        <div
                          className={`w-10 h-10 rounded-xl flex items-center justify-center mb-3 ${
                            ach.unlocked ? "bg-secondary text-forest" : "bg-muted text-muted-foreground"
                          }`}
                        >
                        ...
                        {ach.unlocked && (
                          <div className="flex items-center gap-1 mt-2">
                            ...
                            <span className="text-xs text-forest">已解锁</span>
                          </div>
                        )}
                      </div>
                    ))}
              ...
              <Tabs.TabPane key="style" title="风格偏好">
                <div className="bg-card rounded-2xl p-6 shadow-card">
                  ...
                  {[
                    {
                      category: "穿搭风格",
                      tags: ["简约", "休闲", "商务", "运动", "街头", "复古", "文艺", "优雅", "波西米亚", "极简"],
                      selected: ["简约", "休闲", "商务"],
                    },
                    {
                      category: "颜色偏好",
                      tags: ["黑白灰", "大地色", "蓝绿色调", "暖色系", "撞色", "低饱和"],
                      selected: ["黑白灰", "大地色"],
                    },
                    {
                      category: "版型偏好",
                    ...
                    <div key={group.category} className="mb-6">
                      <label className="text-sm font-medium text-foreground block mb-3">{group.category}</label>
