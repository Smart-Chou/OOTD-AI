    ...
    <div className="min-h-screen bg-background">
          ...
          <div className="flex items-center gap-16">
            ...
            <div className="flex-1 max-w-xl">
              <div className="flex items-center gap-2 mb-6">
                <Tag color="gold" style={{ borderRadius: "999px", padding: "4px 12px" }}>
              ...
              <p className="text-lg leading-relaxed mb-8" style={{ color: "rgba(255,255,255,0.75)" }}>
                输入你的体型数据，上传衣物照片，AI 即刻生成专属穿搭方案。每天用 2 分钟，轻松搞定全周造型。
              </p>
              ...
              <div className="relative w-80 h-96">
                ...
                >
                  <div className="p-4">
                      ...
                      >
                        <div className="flex items-center gap-3">
                          ...
                          <div className="ml-auto flex items-center gap-1">
                            ...
                            <span className="text-xs text-primary-foreground opacity-70">{[97,92,88][i]}%</span>
                          </div>
                        </div>
                      </div>
                    ))}
                    ...
                    >
                      <span className="text-xs text-primary-foreground opacity-80">✨ AI 已为你生成 3 套搭配</span>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <section className="py-16 px-12 bg-muted" style={{ width: "1440px", margin: "0 auto" }}>
        <div className="text-center mb-10">
          ...
          <p className="text-muted-foreground text-sm">无论什么场合，AI 都能为你搭配出最合适的造型</p>
        </div>
      ...
      <section className="py-20 px-12" style={{ width: "1440px", margin: "0 auto" }}>
        ...
        <div className="flex gap-6">
          {TESTIMONIALS.map((t, i) => (
            <div key={i} className="flex-1 bg-card rounded-2xl p-6 shadow-card border border-border">
              <div className="flex items-center gap-1 mb-4">
                {[...Array(t.rating)].map((_, si) => (
                  <Star key={si} className="w-4 h-4 text-gold fill-current" style={{ color: "var(--gold)" }} />
                ))}
              </div>
      ...
      {/* CTA Section */}
      <section className="py-20 px-12 gradient-hero" style={{ width: "1440px", margin: "0 auto" }}>
      ...
      {/* Footer */}
      <footer className="bg-card border-t border-border py-8 px-12" style={{ width: "1440px", margin: "0 auto" }}>
