          ...
          <Row gutter={16}>
            <Col xs={24} sm={12}>
              <Form.Item label="身高 (cm)" name="height" rules={[{ required: true, message: '请输入身高' }]}>
                <InputNumber style={{ width: '100%' }} min={100} max={250} placeholder="170" />
              </Form.Item>
            </Col>
            <Col xs={24} sm={12}>
              <Form.Item label="体重 (kg)" name="weight" rules={[{ required: true, message: '请输入体重' }]}>
                <InputNumber style={{ width: '100%' }} min={30} max={200} placeholder="60" />
              </Form.Item>
            </Col>
          </Row>
          ...
          <Row gutter={16}>
            <Col xs={24} sm={12}>
              <Form.Item label="年龄" name="age">
                <InputNumber style={{ width: '100%' }} min={10} max={100} placeholder="25" />
              </Form.Item>
            </Col>
            <Col xs={24} sm={12}>
          ...
          <Row gutter={16}>
            <Col xs={24} sm={12}>
              <Form.Item label="胸围 (cm)" name="chest">
                <InputNumber style={{ width: '100%' }} min={50} max={150} placeholder="90" />
              </Form.Item>
            </Col>
            <Col xs={24} sm={12}>
              <Form.Item label="腰围 (cm)" name="waist">
                <InputNumber style={{ width: '100%' }} min={40} max={150} placeholder="75" />
              </Form.Item>
            </Col>
          </Row>
          ...
          <Row gutter={16}>
            <Col xs={24} sm={12}>
              <Form.Item label="臀围 (cm)" name="hips">
                <InputNumber style={{ width: '100%' }} min={50} max={150} placeholder="95" />
              </Form.Item>
            </Col>
            <Col xs={24} sm={12}>
              <Form.Item label="肩宽 (cm)" name="shoulder_width">
                <InputNumber style={{ width: '100%' }} min={30} max={60} placeholder="42" />
              </Form.Item>
            </Col>
          </Row>
