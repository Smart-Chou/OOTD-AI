...
const DEFAULT_UTFITS = [
  { id: 1, title: "春日通勤简约风", occasion: "通勤", style: "简约", matchScore: 97, itemCount: 3, imageIndex: 0 },
  { id: 2, title: "周末休闲出游搭", occasion: "休闲", style: "随性", matchScore: 94, itemCount: 4, imageIndex: 1 },
  { id: 3, title: "约会精致优雅感", occasion: "约会", style: "优雅", matchScore: 91, itemCount: 3, imageIndex: 2 },
  { id: 4, title: "运动健身活力系", occasion: "运动", style: "运动", matchScore: 89, itemCount: 3, imageIndex: 3 },
  { id: 5, title: "商务正式沉稳风", occasion: "商务", style: "正式", matchScore: 95, itemCount: 4, imageIndex: 0 },
  { id: 6, title: "户外露营探索感", occasion: "户外", style: "休闲", matchScore: 88, itemCount: 5, imageIndex: 1 },
];
          ...
          <div className="w-64 flex-shrink-0">
            ...
            <div className="gradient-hero rounded-2xl p-5 mb-4">
              <div className="flex items-center gap-2 mb-3">
                ...
                <span className="font-semibold text-primary-foreground text-sm">AI 智能搭配</span>
              </div>
              <p className="text-xs mb-4" style={{ color: "rgba(255,255,255,0.75)" }}>
                基于你的体型数据和风格偏好，AI 已生成 {outfits.length} 套专属搭配方案
              </p>
              <button
                onClick={handleGenerate}
            ...
            <div className="bg-card rounded-2xl p-5 shadow-card mb-4">
              ...
              <div className="mb-4">
                <label className="text-xs font-medium text-muted-foreground block mb-2">穿搭场合</label>
                {OCCASIONS.map((occ) => (
                  <button
                    key={occ}
              ...
              <div className="mb-4">
                <label className="text-xs font-medium text-muted-foreground block mb-2">穿搭风格</label>
              ...
              <div>
                <label className="text-xs font-medium text-muted-foreground block mb-3">
                  最低匹配度：<span className="text-forest font-semibold">{minScore}%</span>
                </label>
                <Slider
                  min={60}
                  max={100}
          ...
          <div className="flex-1">
            <div className="flex items-center justify-between mb-5">
              <span className="text-sm text-muted-foreground">
                共找到 <span className="text-foreground font-semibold">{filteredOutfits.length}</span> 套搭配方案
              </span>
              {selectedOutfit && (
                <div className="flex items-center gap-2">
                  <CheckCircle className="w-4 h-4 text-forest" />
                  <span className="text-sm text-forest font-medium">已选择搭配 #{selectedOutfit}</span>
                </div>
              )}
            </div>
            ...
            {isGenerating ? (
              <div className="flex flex-col items-center justify-center py-24">
                ...
                <p className="text-muted-foreground text-sm mt-4">AI 正在为你生成专属搭配方案...</p>
                <p className="text-xs text-muted-foreground mt-1">分析体型数据 · 匹配单品 · 生成效果图</p>
              </div>
            ) : (
